...
<template>
    <div class="set-user-password w-full">
        <div class="relative">
            ...
            <input v-model="inputValue" type="password" :name="name" :id="id" :placeholder="placeholder" :disabled="disabled" :required="required" :aria-invalid="!!error" :aria-describedby="error ? `${id}-error` : undefined"
